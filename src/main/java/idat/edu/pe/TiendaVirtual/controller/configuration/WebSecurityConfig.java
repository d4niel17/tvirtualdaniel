...
public class WebSecurityConfig  extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/css/**", "/imagenes/**", "/js/**", "/", "/principal", "/home", "/administrador", "/inicio", "/logeo", "/login","/rest/**")
		.permitAll()
		.antMatchers("/usuarios/listarTodo").hasAnyRole("ADMIN","LECTOR","CREADOR","EDITOR","DEPURADOR")
